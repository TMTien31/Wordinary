...
function updateMainSidebarButton() {
  ...
  const viewNamesVi = { isleView:"Đảo của bạn", libraryView:"Thư viện", cardsView:"Từ vựng", reviewView:"Luyện tập", readerView:"Đọc", pdfView:"PDF", videoView:"Video", dictationView:"Chép chính tả", settingsView:"Cài đặt" };
  const viewNamesEn = { isleView:"Your Isle", libraryView:"Library", cardsView:"Vocabulary", reviewView:"Practice", readerView:"Read", pdfView:"PDF", videoView:"Video", dictationView:"Dictation", settingsView:"Settings" };
  $$(".nav-btn").forEach(nav => {
