...
export class HUD {
    constructor(game, root = document) {
        this.game = game;
        this.timeEl    = root.getElementById('hud-time');
        this.aoToggle  = root.getElementById('toggle-ao');
        this.gridToggle= root.getElementById('toggle-grid');
        this.bordersToggle = root.getElementById('toggle-borders');
