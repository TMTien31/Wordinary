...
export class InputManager {
        ...
        if (this._touchMode === 'single') {
            ...
            if (tool === 'pan') {
                ...
                if (key !== this._lastBrushTouchKey) {
                    if (!this._lastBrushTouchKey) this.game.beginHistoryBatch();
    ...
    _onTouchEnd(e) {
        ...
        if (remaining === 0) {
            if (this._lastBrushTouchKey) this.game.endHistoryBatch();
