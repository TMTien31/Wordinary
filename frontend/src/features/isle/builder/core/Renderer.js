...
const MAX_CACHE_SCALE = Math.max(CONFIG.grid.width, CONFIG.grid.height) > 20 ? 2 : 3;
const CACHE_SCALE = Math.min(MAX_CACHE_SCALE, Math.max(2, Math.ceil(_DPR * 1.5)));
...
export class Renderer {
    ...
    clearAnimations() {
        ...
        this._animObjectIds.clear();
        this._animTerrainKeys.clear();
        this._objectsVersion = -1;
        this._terrainVersion = -1;
        this._dirty = true;
    }
